//
//  KiliaroCollectionViewDataSource.swift
//  kiliaro
//
...
/*
 ...
 This is KiliaroCollectionViewDataSource responsible for data source of simple collectionViews.
 
 You can easily add new datas to array by confirming your UICollectionViewCell to KiliaroCollectionViewCell.
 */

protocol KiliaroCollectionViewDelegate: class {
...
class KiliaroCollectionViewDataSource<T: KiliaroCollectionViewCell>: NSObject, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    // MARK: - Variables
    ...
    // MARK: - Initializer
    init(items: [T.CellViewModel], collectionView: UICollectionView, delegate: KiliaroCollectionViewDelegate) {
        self.items = items
